...
| :---: | :--- | :---: | :--- | :--- | :--- |
| ✅ | Dựng hạ tầng & Database | — | `main` | Migration DB, DatabaseSeeder nạp 2 role (Admin, Author), 2 tài khoản mẫu và sinh ngẫu nhiên dữ liệu thực tế (23 Categories, 100 Recipes chuẩn văn hóa ẩm thực Việt). | — |
